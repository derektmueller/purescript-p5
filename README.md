...
Completed:
  * generate FFI PureScript functions for p5.js functions of basic types (e.g. Number, String, Boolean), array types, optional types, and product types (e.g. Number|String)
